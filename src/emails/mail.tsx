...
export default function Email() {
  ...
  return (
    <Html>
      <Head />
      <Preview>Customer email</Preview>
      <Section style={main}>
        <Container style={container}>
          <Section style={{ marginTop: "32px" }}>
            <Img
              src="https://amazing-brown-aab3eb.netlify.app/assets/images/20.png"
              width="50%"
              height="50%"
              style={logo}
            />
          ...
          <Text style={h1}>
            I would like more <strong>Information</strong> about to tour{" "}
            <strong>Cusco City</strong>
          </Text>
          ...
          <Text style={footer}>
            ...
            <span style={black}>eco peru hikes</span>.This invite was sent from{" "}
            <span style={black}>204.13.186.218</span> located in{" "}
            <span style={black}>Cusco, Peru</span>. If you were not expecting
